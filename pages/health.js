...
function HealthPage(){
 ...
 <section class="card health-entry-card"><div class="section-title"><div><span class="section-kicker">⚖️ Track</span><h2>Add weight</h2></div><span class="live-time">Time added automatically</span></div><div class="health-input-stack"><input class="field date-field" id="weightDate" type="date" value="${today()}"><input class="field" id="weightValue" type="number" step="0.1" placeholder="kg"></div><button class="primary" id="addWeight" style="margin-top:10px">Save weight</button></section>
 <section class="card health-entry-card"><div class="section-title"><div><span class="section-kicker">📏 Track</span><h2>Add measurements</h2></div><span class="live-time">Time added automatically</span></div><input class="field date-field" id="measureDate" type="date" value="${today()}"><div class="health-measure-fields" style="margin-top:10px"><input class="field" id="measureWaist" type="number" step="0.1" placeholder="Waist cm"><input class="field" id="measureTummy" type="number" step="0.1" placeholder="Tummy cm"></div><button class="primary" id="addMeasure" style="margin-top:10px">Save measurements</button></section>
 </div>`;
