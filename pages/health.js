...
function HealthPage(){
 ...
 <section class="card health-entry-card"><div class="section-title"><div><span class="section-kicker">📏 Track</span><h2>Add measurements</h2></div><span class="live-time">Time added automatically</span></div>
  <input class="field date-field" id="measureDate" type="date" value="${today()}">
  <div class="health-measure-fields" style="margin-top:10px">
